...
X_train = train_df[independent_cols]  # split our dataset between dependent and independent columns
...
model.fit(X=X_train, y=y_train)  # Fit the model on the training dataset
