...
::: {.pull-left}
![Bias Variance Data 1](img/bias-variance-data-1.png){width=900}
:::

::: {.pull-right}
![Bias Variance Data 2](img/bias-variance-data-2.png){width=900}
...
::: {.pull-left}
![Bias Variance Data 3](img/bias-variance-data-3.png){width=900}
:::

::: {.pull-right}
![Bias Variance Data 4](img/bias-variance-data-4.png){width=900}
:::
...
::: {.pull-left}
![Bias Variance Data 5](img/bias-variance-data-5.png){width=900}
:::

::: {.pull-right}
![Bias Variance Data 6](img/bias-variance-data-6.png){width=900}
:::
