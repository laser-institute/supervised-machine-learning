...
- Is there a specific use case of machine learning in which you are especially interested?
...
-   What is a research question you could ask that could be approached with SML?
:::
...
> Zong, C., & Davis, A. (2022). Modeling university retention and graduation rates using IPEDS. *Journal of College Student Retention: Research, Theory & Practice*, https://journals.sagepub.com/doi/10.1177/15210251221074379.

## Case Study

-   Building a prediction model for graduate rates using data from the National Center for Education Statistics.
