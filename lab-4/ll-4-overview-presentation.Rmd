...
- Brief overview of unsupervised methods
- Time to discuss your questions/topic
...
---
# A bit more on using machine learning in science
...
# Kubsch et al.s (2023) DEFT Framework

```{r, fig.align = "middle", echo = FALSE}
knitr::include_graphics("deft.png")
```
