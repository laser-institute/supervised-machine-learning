...
=======
+--------+--------+----------------------------------+--------+--------+
| S      | How to | Interpretation                   | Value  | \%     |
| ta     | Find   |                                  |        |        |
| tistic |        |                                  |        |        |
+:======:+:======:+:================================:+:======:+:======:+
| True   | Truth: | Proportion of the population     | 2443   | 19.8   |
| po     | 1, Pre | that is affected by a condition  |        |        |
| sitive | di     | and correctly tested positive    |        |        |
| (TP)   | ction: |                                  |        |        |
|        | 1      |                                  |        |        |
+--------+--------+----------------------------------+--------+--------+
| True   | Truth: | Proportion of the population     | 4536   | 36.8   |
| ne     | 0, Pre | that is not affected by a        |        |        |
| gative | di     | condition and correctly tested   |        |        |
| (TN)   | ction: | negative                         |        |        |
|        | 0      |                                  |        |        |
+--------+--------+----------------------------------+--------+--------+
| False  | Truth: | Proportion of the population     | 2070   | 16.8   |
| po     | 0, Pre | that is not affected by a        |        |        |
| sitive | di     | condition and incorrectly tested |        |        |
| (FP)   | ction: | positive                         |        |        |
|        | 1      |                                  |        |        |
+--------+--------+----------------------------------+--------+--------+
| False  | Truth: | Proportion of the population     | 3269   | 26.5   |
| ne     | 1, Pre | that is affected by a condition  |        |        |
| gative | di     | and incorrectly tested positive. |        |        |
| (FN)   | ction: |                                  |        |        |
|        | 0      |                                  |        |        |
+--------+--------+----------------------------------+--------+--------+
>>>>>>> bd1f9a70dcd4505d0230db09b2684f47ffc233de
...
=======
+:----------:+:----------:+:----------:+:----------:+:----------:+
| **S        | -   \*Eq   | **Interp   | **Question | **S        |
| tatistic** | uation\*\* | retation** | Answered** | tatistic** |
|            |            |            |            |            |
|            |            |            |            | **Values** |
+------------+------------+------------+------------+------------+
| **Sen      | TP / (TP + | Proportion | Out of all | .428       |
| sitivity** | FN)        | of those   | the actual |            |
| (AKA       |            | who are    | positives, |            |
| recall)    |            | affected   | how many   |            |
|            |            | by a       | did we     |            |
|            |            | condition  | correctly  |            |
|            |            | and        | predict?   |            |
|            |            | correctly  |            |            |
...
|            |            | positive   |            |            |
+------------+------------+------------+------------+------------+
| **Spe      | TN / (FP + | Proportion | Out of all | .687       |
| cificity** | TN)        | of those   | the actual |            |
|            |            | who are    | negatives, |            |
|            |            | not        | how many   |            |
|            |            | affected   | did we     |            |
|            |            | by a       | correctly  |            |
...
|            |            | negative;  |            |            |
+------------+------------+------------+------------+------------+
| **P        | TP / (TP + | Proportion | Out of all | .581       |
| recision** | FP)        | of those   | the        |            |
| (AKA       |            | who tested | instances  |            |
| Positive   |            | positive   | we         |            |
| Predictive |            | who are    | predicted  |            |
| Value)     |            | affected   | as         |            |
|            |            | by a       | positive,  |            |
|            |            | condition  | how many   |            |
|            |            |            | are        |            |
...
|            |            |            | positive?  |            |
+------------+------------+------------+------------+------------+
| **Negative | TN / (TN + | Proportion | Out of all | .541       |
| Predictive | FN)        | of those   | the        |            |
| Value**    |            | who tested | instances  |            |
|            |            | positive   | we         |            |
|            |            | who are    | predicted  |            |
|            |            | not        | as         |            |
|            |            | affected   | negative,  |            |
...
| Accuracy       |                                                     |
+----------------+-----------------------------------------------------+
| Sensitivity    | The model correctly predicts about 2/3 of students  |
| (AKA recall)   | who do not pass correctly (as not passing). This is |
