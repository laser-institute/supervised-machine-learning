...
# **edit: if your data has 10,000+ rows, d <- distinct(student_id, course_id, .keep_all = TRUE) **
...
```{r}
my_rec <- recipe(final_grade ~ ., data = data_train) %>% # **edit**: change t final grade
...
# okay to ignore warnings here
fitted_model_resamples <- fit_resamples(my_wf, resamples = kfcv, # **edit: this should be fitted_model_resamples**
