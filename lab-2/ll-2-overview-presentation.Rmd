...
# Trying to reflect on the big picture
...
- If you are still figuring out how you are planning to use ML . . . 
    - Great! Let's make progress
- If you have a _specific use of ML in mind_ . . . 
    - Negin to look for _how_ you can achieve your goal
...
.panel[.panel-name[Today]
 ...
 - We'll recap ML LL #1
 - Then dive into the presentation for ML LL #2
 - We'll reserve at least one hour for discussion
