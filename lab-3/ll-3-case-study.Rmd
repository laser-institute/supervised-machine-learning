...
Please load `oulad-interactions.csv` into R, assigning the resulting data frame the name `interactions`.
...
In the OULAD documentation, this is called the VLE
...
Woah, even filtered, this is a large file! Let's start to explore it a bit. Please take
