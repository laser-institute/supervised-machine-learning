...
- Key Concept #2: Bias-variance trade-off
- Discussion 2
...
- We want to make predictions about an outcome of interest based on predictor (or indendent) variable(s) that we think are related to the outcome (or dependent variable).
- We'll again be using [IPEDS, the Integrated Postsecondary Education Data System](https://nces.ed.gov/ipeds/) data.
...
::: notes
While students used the SML frame in Module 1, it was sort of glossed over. We go into more depth in the case study.
:::
