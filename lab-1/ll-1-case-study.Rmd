...
students file includes five files joined together: studentInfo, courses,
and studentRegistration. The assessment file includes studentAssessments
and Assessments. Take a look at the data description to get a sense for
what variables are in which data frame.
