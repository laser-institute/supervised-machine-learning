...
We'll create another predictor variable for students' self-reported disability status, 
but we'll do this as sa part of our machine learning workflow (in Step 2, below).
...
variables. We'll also add `step_dummy()`, which dummy codes the specified variable -- here, for students' self-reported disability status.
