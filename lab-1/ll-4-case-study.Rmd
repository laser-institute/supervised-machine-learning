...
In this project, hundreds of hours of video and audio were collected
from high school and middle school classrooms. The specific data set we
are using is transcribed data (via
...
> Schmidt, J. A. (2019). tidyLPA: An R package to easily carry out
> latent profile analysis (LPA) using open-source or commercial
> software. Journal of Open Source Software, 3(30), 978.
> <https://joss.theoj.org/papers/10.21105/joss.00978.pdf>
