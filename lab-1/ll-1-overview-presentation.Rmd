...
- Using 1000s of qualitative codes from two years of the chat, we explore how well a computer can scale up this coding **to code others years data**
...
- **Badge**: In the independent practice, you'll focus on interpreting the fit measures (agreement, Kappa, and others)  
