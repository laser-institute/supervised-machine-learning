...
subtitle: "Conceptual Overview - Foundations"
format:
  revealjs: 
    slide-number: c/t
    progress: true
...
<center>In supervised ML, our goal is to minimize the difference between a known $y$ and our predictions, $\hat{y}$</center>
...
If we are interested in making the best possible predictions, we can add a _bunch_ of predictors and see how much we can minimize the prediction error
