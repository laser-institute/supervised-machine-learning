...
Maestrales et al. (2021) present a great example of how coded data and a coding frame can be "scaled up", here for assessment-related purposes. Read through this paper, noting how the authors tuned the performance of their supervised machine learning classification models.
