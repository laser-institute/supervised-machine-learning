...
knitr::include_graphics("lab-1/img/gpt-3.png")
```
...
**Using audio data, prosodic features, automatic speech recognition, and send related methods** (in progress!)
...
- LL 1: Prediction: How is prediction different from explanation?
- LL 2: Interpretation: How do we interpret the accuracy of a machine learning model?
- LL 3: Improvement: How can we make a better model?
- LL 4: Discovery: What if we do not have training data?
